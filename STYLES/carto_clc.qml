...
<qgis version="2.14.11-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="nature" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="9" value="PERIURBAIN" label="PERIURBAIN"/>
      ...
      <category render="true" symbol="14" value="A/NATUREL" label="A/NATUREL"/>
      <category render="true" symbol="15" value="A/ESP.VERTS" label="A/ESP.VERTS"/>
      <category render="true" symbol="16" value="A/ARTIFICIALISE" label="A/ARTIFICIALISE"/>
      <category render="true" symbol="17" value="A/ZONE_HUMIDE" label="A/ZONE_HUMIDE"/>
