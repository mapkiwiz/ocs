...
<qgis version="2.14.11-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="tileid">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="nature" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="8" value="AUTRE/INFRA" label="AUTRE/INFRA"/>
      <category render="true" symbol="9" value="AUTRE/ARTIFICIALISE" label="AUTRE/ARTIFICIALISE"/>
      <category render="true" symbol="10" value="NEIGE" label="NEIGE"/>
      <category render="true" symbol="11" value="ROCHERS" label="ROCHERS"/>
      <category render="true" symbol="12" value="A/FORET" label="A/FORET"/>
      <category render="true" symbol="13" value="A/PELOUSE" label="A/PELOUSE"/>
      <category render="true" symbol="14" value="A/LANDES" label="A/LANDES"/>
      <category render="true" symbol="15" value="A/CARRIERE" label="A/CARRIERE"/>
      <category render="true" symbol="16" value="A/LOGISTIQUE" label="A/LOGISTIQUE"/>
      <category render="true" symbol="17" value="A/AGRICOLE" label="A/AGRICOLE"/>
      <category render="true" symbol="18" value="A/PRAIRIE" label="A/PRAIRIE"/>
      <category render="true" symbol="19" value="A/VIGNE" label="A/VIGNE"/>
      <category render="true" symbol="20" value="A/ZONE_HUMIDE" label="A/ZONE_HUMIDE"/>
      <category render="true" symbol="21" value="A/NATUREL" label="A/NATUREL"/>
    </categories>
    <symbols>
