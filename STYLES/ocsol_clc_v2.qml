...
<qgis version="2.14.11-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="code_clc">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="nature" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="EAU" label="EAU"/>
      <category render="true" symbol="1" value="INFRA" label="INFRA"/>
      <category render="true" symbol="2" value="BATI" label="BATI"/>
      <category render="true" symbol="3" value="CULTURES" label="CULTURES"/>
      <category render="true" symbol="4" value="PRAIRIE" label="PRAIRIE"/>
      <category render="true" symbol="5" value="ARBORICULTURE" label="ARBORICULTURE"/>
      <category render="true" symbol="6" value="VIGNE" label="VIGNE"/>
      <category render="true" symbol="7" value="FORET" label="FORET"/>
      <category render="true" symbol="8" value="NATUREL" label="NATUREL"/>
      <category render="true" symbol="9" value="PERIURBAIN" label="AUTRE/ARTIFICIALISE"/>
      <category render="true" symbol="10" value="AUTRE/INFRA" label="AUTRE/INFRA"/>
      <category render="true" symbol="11" value="NEIGE" label="NEIGE"/>
      <category render="true" symbol="12" value="ROCHERS" label="ROCHERS"/>
      <category render="true" symbol="13" value="A/FORET" label="A/FORET"/>
      <category render="true" symbol="14" value="A/PELOUSE" label="A/PELOUSE"/>
      <category render="true" symbol="15" value="A/LANDES" label="A/LANDES"/>
      <category render="true" symbol="16" value="A/CARRIERE" label="A/CARRIERE"/>
      <category render="true" symbol="17" value="A/LOGISTIQUE" label="A/LOGISTIQUE"/>
      <category render="true" symbol="18" value="A/AGRICOLE" label="A/AGRICOLE"/>
      <category render="true" symbol="19" value="A/PRAIRIE" label="A/PRAIRIE"/>
      <category render="true" symbol="20" value="A/VIGNE" label="A/VIGNE"/>
      <category render="true" symbol="21" value="A/ZONE_HUMIDE" label="A/ZONE_HUMIDE"/>
      <category render="true" symbol="22" value="A/NATUREL" label="A/NATUREL"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="10">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="250,124,169,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="18">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="230,230,138,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="9">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="250,163,169,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
    ...
    <colorramp type="cpt-city" name="[source]">
      <prop k="schemeName" v="cb/qual/Accent"/>
      <prop k="variantName" v="_08"/>
    </colorramp>
