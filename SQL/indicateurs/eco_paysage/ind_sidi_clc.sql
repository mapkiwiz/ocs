CREATE OR REPLACE FUNCTION ind.ind_sidi_clc(cell_10km bigint)
...
CREATE OR REPLACE FUNCTION ind.ind_sidi_clc()
RETURNS TABLE (cid int, value double precision, msidi double precision)
AS
$func$
DECLARE
...
BEGIN
    ...
    LOOP
        ...
        RETURN QUERY
        SELECT * FROM ind.ind_sidi_clc(cell_10km);
...
CREATE TABLE ind_aura.sidi_clc AS
SELECT * FROM ind.ind_sidi_clc();