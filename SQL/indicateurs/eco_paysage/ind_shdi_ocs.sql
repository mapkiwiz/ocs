CREATE OR REPLACE FUNCTION ind.ind_shdi_ocsol(cell_10km bigint)
...
CREATE OR REPLACE FUNCTION ind.ind_shdi_ocsol()
RETURNS TABLE (cid int, value double precision)
AS
$func$
DECLARE
...
BEGIN
    ...
    LOOP
        ...
        RETURN QUERY
        SELECT * FROM ind.ind_shdi_ocsol(cell_10km);
...
CREATE TABLE ind_aura.shdi_ocs AS
SELECT * FROM ind.ind_shdi_ocsol();