...
CREATE OR REPLACE FUNCTION ind.ind_cde_principal_longueur(query_dept text)
RETURNS TABLE (cid int, length_m double precision)
AS
$func$
DECLARE
...
CREATE TABLE ind.cde_principal_longueur_cantal AS
SELECT * FROM ind.ind_cde_principal_longueur('CANTAL');