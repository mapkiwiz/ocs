...
CREATE OR REPLACE FUNCTION ind.ind_foret_type_dominant()
RETURNS TABLE (cid int, surf_rank int, nature varchar(25), surf_ha double precision)
AS
$func$
DECLARE
...
CREATE TABLE ind_aura.foret_type_dominant AS
SELECT * FROM ind.ind_foret_type_dominant();